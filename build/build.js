...
serand.on('user', 'logout', function () {
    ...
    $.ajax({
        method: 'DELETE',
        url: utils.resolve('apis:///v/tokens/' + user.access),
        dataType: 'json',
        success: function (data) {
...
require.register("serandomps~uready@master", function (exports, module) {
var serand = require('serandomps~serand@master');
...
var dust = require('serandomps~dust@master')();
var serand = require('serandomps~serand@master');
var autils = require('serandomps~autos-utils@master');
var utils = require('serandomps~utils@master');

var cdn = autils.cdn();

var AUTO_API = utils.resolve('apis:///v/vehicles');
...
var list = function (el, options, fn) {
    $.ajax({
        url: utils.resolve('apis:///v/vehicles' + query(options)),
        dataType: 'json',
        success: function (data) {
...
require.register("serandomps~autos-navigation@master", function (exports, module) {
var serand = require('serandomps~serand@master');
...
var render = function (done) {
    $.ajax({
        url: utils.resolve('apis:///v/menus/1'),
        dataType: 'json',
...
require.register("autos", function (exports, module) {
var dust = require('serandomps~dust@master')();

var serand = require('serandomps~serand@master');
var utils = require('serandomps~utils@master');
var uready = require('serandomps~uready@master');
