...
module.exports = function (sandbox, fn, options) {
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            dust.render('vehicles-details', autils.cdn800x450(data), function (err, out) {
                sandbox.append(out);
                if (!fn) {
                    return;
                }
...
var list = function (el, options, fn) {
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            dust.render('vehicles-listing', autils.cdn288x162(data), function (err, out) {
